...
const AudioTracks = ({navigation, route}) => {
  ...
  const handleUpdateTrack = selected => {
    ...
    if (isValid) {
      ...
      console.log('hggv==>>', editingIndex, JSON.stringify(eList));
              ...
              <View
                ...
                <View
                  ...
                  <View style={{flex: 1}}>
                    ...
                    <Text>
                      Artist:{' '}
                      {item?.artistList?.map(artist => artist?.item).join(', ')}{' '}
                    </Text>
            ...
            <View>
              ...
              <>
                <Text
                  style={[
                    styles.artistTxt,
                    {marginBottom: 0, marginVertical: 5},
                  ]}>
                  Artist*:
                </Text>
                <SelectBox
              ...
              <View>
                <ReleaseInput
                  ...
                  onChangeText={text =>
                    handleOnChangeForm(text, 'composerfirstname')
                  }
                />
                <ReleaseInput
                  ...
                  onChangeText={text =>
                    handleOnChangeForm(text, 'composerlastname')
                  }
              ...
              <View>
                <ReleaseInput
                  ...
                  onChangeText={text =>
                    handleOnChangeForm(text, 'lyricistfirstname')
                  }
                />
                <ReleaseInput
                  ...
                  releaseInputMainContainerStyle={{marginTop: -20}}
                  onChangeText={text =>
                    handleOnChangeForm(text, 'lyricistlastname')
                  }
                />
              </View>
              ...
              <DropdownPicker
                ...
                defaultOption={{
                  key: formData.mainGener,
                  value: formData.mainGener,
                }}
              />
              ...
              <DropdownPicker
                ...
                onSelect
                defaultOption={{
                  key: formData.subGener,
                  value: formData.subGener,
                }}
              />
              ...
              <View>
                ...
                <TextButton onPress={pickAudio} label="Select Tracks" />
              </View>
              ...
              <View
                ...
                <CheckBox
                  ...
                  onValueChange={newValue =>
                    setExplicittoggleCheckBox(newValue)
                  }
                />
              </View>
