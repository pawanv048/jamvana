...
import { CustomActivityIndicator } from '../Custom/CustomComponent'
...
//    //console.log('selectTrackAudio=>', selectTrackAudio);
...
//          //setSelectTrackAudio([...selectTrackAudio, {...addNewFormInput}])
//          //setMultipleFiles([...selectTrackAudio, { ...addNewFormInput }]);
//          //setMultipleFiles([...selectedAudioFiles, { ...addNewFormInput }]);
//          //console.log('selectTrackAudio=>', selectTrackAudio);
//       }
...
//    const handleAddNew = () => {
//       setLoading(true)
//       setEditingIndex(multipleFiles.length + 1);
//       setSelectedArtists([])
//       setAddNewFormInput({
//          featureartist: formData.featureArtist,
//          displayartist: formData.displayArtist,
...
//                         value={editingIndex !== null ? editingIndex.toString() : (multipleFiles.length + 1).toString()}
//                         labelContainer={{
//                            color: 'white',
//                            fontWeight: 'bold'
//                         }}
//                         //onChangeText={(val) => setEditingIndex(val)}
//                      />
...
//                      {/* select Track */}
//                      {selectTrackAudio.length > 0 && selectTrackAudio.map((item, index) => (
//                         <View
//                            key={index.toString()}
//                            style={{
//                               flexDirection: 'row',
